...
description: Linxu中的IO模型问题，很好的诠释了为什么Nginx在静态文件加载速度上比apache要快许多
date: 2016/08/28 23:24:25 
---

# epoll介绍
转自知乎

作者：[蓝形参](https://www.zhihu.com/people/thynson)，Geek 伪技术宅 
...
看完以上对于epoll的介绍，对于linux中的IO模型有了一定的认知
相比于传统的select/poll模型，epoll利用了事件通知的形式，减少了接受IO信号后对所有socket进行轮询的开销，大大提升效率
